...
$$ \text{Symbol} = \text{Module}(id) \mid \text{Type}(id) \mid
\text{Value}(\tau) $$
L'intuizione architetturale fondamentale risiede nell'entità
\text{Value}, che conserva il tipo ($\tau$) o la sua query non
risolta. Questa struttura permette al valutatore di inferire i tipi
