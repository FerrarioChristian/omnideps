...
\begin{itemize}
  ...
  \item $\mathcal{GR}$ è il \textbf{Global Registry}: un indice
    ...
    architetturali (es. tipi di ritorno e firme ereditate). È il
    motore che garantisce tempi di accesso costanti $\mathcal{O}(1)$,
    eliminando il degrado prestazionale delle navigazioni ad albero.
